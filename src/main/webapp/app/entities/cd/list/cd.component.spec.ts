...
describe('Cd Management Component', () => {
  let comp: CdComponent;
  let fixture: ComponentFixture<CdComponent>;
  let service: CdService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cd', component: CdComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cds?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
