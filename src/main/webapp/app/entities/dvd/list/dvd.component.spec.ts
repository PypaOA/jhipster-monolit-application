...
describe('Dvd Management Component', () => {
  let comp: DvdComponent;
  let fixture: ComponentFixture<DvdComponent>;
  let service: DvdService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dvd', component: DvdComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dvds?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
